...
namespace Pos.Model.Context
{
    public class PosContext : DbContext
    {
        ...
        public DbSet<IngresosUltimaSemanaView> IngresosUltimaSemana { get; set; }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<IngresosUltimaSemanaView>().HasNoKey().ToView("vw_total_ingresos_ultima_semana");
        }
    }
}
