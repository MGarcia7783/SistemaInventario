...
namespace Pos.Service.Mappigns
{
    public class mappingProfile : Profile
    {
        public mappingProfile()
        {
            ...
            .ForMember(destino => destino.categoriaDescripcion,
                opt => opt.MapFrom(origen => origen.Categoria != null ? origen.Categoria.descripcion : string.Empty)
            )
            ...
            .ForMember(destino => destino.idCatagoria,
                opt => opt.MapFrom(origen => origen.idCatagoria)
            )
            ...
            CreateMap<ProductosMasVendidosView, ProductosMasVendidosDTO>();
            CreateMap<ProductosPorAgotarView, ProductosPorAgotarDTO>();
            CreateMap<VentasUltimaSemanaView, VentasUltimaSemanaDTO>();
            CreateMap<TotalProductosVendidosView, TotalProductosVendidosDTO>();
            CreateMap<IngresosUltimaSemanaView, IngresosUltimaSemanaDTO>();
