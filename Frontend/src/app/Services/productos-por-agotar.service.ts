...
import { ProdcutosPorAgotar } from '../Interface/prodcutos-por-agotar';

@Injectable({
  providedIn: 'root'
})
export class ProductosPorAgotarService {

  private apiUrl = environments.apiUrl + '/dashboard/productos_por_agotar';

  constructor(private http: HttpClient) { }

  //Método para obtener las ventas
      getProductosPorAgotar(): Observable<ProdcutosPorAgotar[]> {
        return this.http.get<ProdcutosPorAgotar[]>(this.apiUrl).pipe(
